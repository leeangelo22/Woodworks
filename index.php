...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center"><span>+63 9452742820</span></i>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">P.R.S. Woodworks</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Welcome to <span>P.R.S. Woodworks</span></h1>
          <h2>We accept made to order designs!</h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>The business objective is to make sure to give your order in good and quality service.</h3>
            <p class="fst-italic">
              Here at P.R.S. Woodworks, we are proud to be known as quality wood designers and makers. We offer a seamless service – from innovative design to skilful craftsmanship and flawless installation.

              When you choose to work with us, there is no limit to your choice. We will work with you to create a truly quality service that reflects your lifestyle, unique vision and interior aesthetic.
              
              Your PRS wood works cabinets will be made with high quality 18mm FSC birch plywood and you can choose from a wide variety of materials and styles. 
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> We customize doors based on your specific designs.</li>
              <li><i class="bi bi-check-circle"></i> Integrated dressing tables and desks.</li>
              <li><i class="bi bi-check-circle"></i> Spacious walk-in closets featuring a range of storage solutions.</li>
            </ul>
            <p>
    ...
    <section id="contact" class="contact">
      ...
      <div data-aos="fade-up" >
       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3246.3501681665725!2d121.11091135802329!3d14.622831060513658!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b84f81dccbc9%3A0x89f49e102b81134e!2s771e%20Marikina-Infanta%20Hwy%2C%20Antipolo%2C%201870%20Rizal!5e0!3m2!1sen!2sph!4v1706362172394!5m2!1sen!2sph" width="2000" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>771-E Marcos Highway Mayamot Antipolo City</p>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>P.R.S. Woodworks</h3>
              <p>
                771-E Marcos Highway<br>
                Mayamot Antipolo City<br><br>
                <strong>Phone:</strong> +63 9452742820<br>
                <strong>Email:</strong> jairosunga@gmail.com<br>
              </p>
              <div class="social-links mt-3">
                <a href="#" class="twitter"><i class="bx bxl-twitter"></i></a>
                <a href="https://www.facebook.com/goay.sunga" class="facebook"><i class="bx bxl-facebook"></i></a>
